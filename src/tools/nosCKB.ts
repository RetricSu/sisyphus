...
export type CKBBalanceToolExecParameter = {};
...
export type myTokenBalanceToolExecParameter = {};
export type AccountInfoToolExecParameter = {};
export interface ReadNostrEventsToolExecParameter {
  kind: string;
}
export type ReadNostrMentionNotesToolExecParameter = {};
...
export type CKBBalanceToolBoxType = ToolBox<
  [CKBBalanceToolExecParameter],
  ReturnType<NosCKB["getBalance"]>
>;
export type PublishNoteToolBoxType = ToolBox<
  [PublishNoteToolExecParameter],
  ReturnType<NosCKB["publishNote"]>
>;
export type TransferCKBToolBoxType = ToolBox<
  [TransferCKBToolExecParameter],
  Promise<{ txHash: Hex }>
>;
...
>;
export type TransferTokenToolBoxType = ToolBox<
  [transferTokenToolExecParameter],
  ReturnType<NosCKB["transferToken"]>
>;
...
export function buildNosCKBToolBox(
  network: Network,
  nostrPrivkey: string,
  relays: string[] = [],
) {
  ...
  const publishNoteToolBox: PublishNoteToolBoxType = {
        ...
        parameters: {
          ...
          properties: {
            text: {
              type: "string",
              description:
                "the text content of the Nostr short post to publish",
            },
          },
          required: ["text"],
        },
    ...
    params: z.object({
      text: z
        .string()
        .describe("the text content of the Nostr short post to publish"),
    }),
        ...
        parameters: {
          ...
          properties: {
            ...
            feeRate: {
              type: "number",
              description:
                "the fee rate for the CKB transfer transaction, default to 1000",
            },
          },
  ...
  const issueTokenToMyselfToolBox: IssueTokenToMyselfToolBoxType = {
        ...
        parameters: {
          ...
          properties: {
            amount: {
              type: "string",
              description:
                "the amount decimal number string of token to be issued",
            },
            feeRate: {
              type: "number",
              description:
                "the CKB fee rate for the token issue transaction, default to 1000",
            },
          },
          required: ["amount"],
        },
    ...
    params: z.object({
      amount: z
        .string()
        .describe("the amount decimal number string of token to be issued"),
      feeRate: z
        .number()
        .optional()
        .describe(
        ...
        parameters: {
          ...
          properties: {
            ...
            feeRate: {
              type: "number",
              description:
                "the fee rate for the token issue transaction, default to 1000",
            },
          },
  ...
  const transferTokenToolBox: TransferTokenToolBoxType = {
        ...
        parameters: {
          ...
          properties: {
            amount: {
              type: "string",
              description:
                "the amount decimal number string of token to be transferred",
            },
            receiverAddress: {
              type: "string",
              description: "the receiver CKB address",
    ...
    params: z.object({
      ...
      feeRate: z
        ...
        .optional()
        .describe(
          "the CKB fee rate for the token transfer transaction, default to 1000",
        ),
    }),
    exec: async ({
      amount,
  ...
  const readNostrEvents: ReadNostrEventsToolBoxType = {
      ...
      function: {
        ...
        description:
          "get nostr social post from nostr network with specific filters",
        parameters: {
          type: "object",
          properties: {
            kind: {
              type: "string",
              description:
                "event kind, a number string, to fetch the event of specific type",
            },
          },
          required: ["kind"],
        },
  ...
  const readMentionNotesWithMe: ReadNostrMentionNotesWithMeToolBoxType = {
      ...
      function: {
        ...
        description:
          "get social notification message (mention-me or reply-to-me posts) from nostr network",
        parameters: {
          type: "object",
          properties: {},
          required: [],
  ...
  const publishReplyNotesToEvent: PublishNostrReplyNotesToEventToolBoxType = {
      ...
      function: {
        ...
        description:
          "publish a reply post to a specific post(a nostr event) in nostr network",
        parameters: {
          type: "object",
          properties: {
            text: {
    ...
    exec: async ({
      ...
      return await nosCKB.publishReplyNotesToEvent(
        text,
        eventIdHexWithoutPrefix,
      );
    },
  };
  ...
  const publishProfileEvent: PublishNostrProfileEventToolBoxType = {
        ...
        parameters: {
          ...
          properties: {
            ...
            about: {
              type: "string",
              description:
                "the introduction/about me/description of yourself in the nostr account profile",
            },
            avatarPictureUrl: {
              type: "string",
    ...
    params: z.object({
      ...
      avatarPictureUrl: z
        .string()
        .optional()
        .describe("the avatar picture url of your nostr profile"),
    }),
    exec: async ({
      name,
      about,
